...
class HaalCentraalBagService(
    ...
    fun getAdresseerbaarObjectIdentificatie(
        ...
        logger.info(
            "Fetching address for postcode: ${addressRequest.postcode}, huisnummer: ${addressRequest.huisnummer}",
        )

        val cleanAddressRequest =
            AddressRequest(
        ...
        val response =
            haalCentraalBagClient.getAdresseerbaarObjectIdentificatie(
                baseUrl = baseUrl,
